...
const handler = async (m, _2, msg, pickRandom, isOwner, fromBot) => {
    if (fromBot) return;
    ...
    const { conn, usedPrefix, noPrefix, args, groupMetadata, command, isROwner, isChannel } = _2;
    if (!isChannel && !isROwner) return;
